...
In the next step `sdmexplain` calls the `lime` package under the hood to generate the explanations.

```{r}
explainable_data <- prepare_explainable_data(data.test, mod, test.coords)
```

Process lime plots to make them suitable for the interactive map.
